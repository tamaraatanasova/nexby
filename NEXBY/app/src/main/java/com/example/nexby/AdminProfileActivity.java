    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setNavigationItemSelectedListener(item -> {
            ...
            if (id == R.id.pocetna) {
                ...
                startActivity(new Intent(AdminProfileActivity.this, ContactAdminActivity.class));
            } else if (id == R.id.addkategorii) {
                // Handle "Add Category" action (you can enable this later)
                 startActivity(new Intent(AdminProfileActivity.this, AddCompanyActivity.class));
            } else if (id == R.id.adduser) {
                // Handle "Add User" action (you can enable this later)
                 startActivity(new Intent(AdminProfileActivity.this, AddUserActivity.class));
